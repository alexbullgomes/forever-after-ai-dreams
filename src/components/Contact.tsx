        ...
        <div className="text-center mb-16">
          <div className="flex justify-center mb-4">
            <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
              <Heart className="w-5 h-5" style={{ color: `hsl(var(--brand-text-accent) / 0.8)` }} />
              <span className="text-sm font-medium" style={{ color: `hsl(var(--brand-badge-bg))` }}>Get In Touch</span>
            </div>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Let's Create Something
            <span className="block bg-brand-gradient bg-clip-text text-transparent" style={{ filter: 'brightness(1.2)' }}>
              Beautiful Together
            </span>
          </h2>
