...
const Option = ({ Icon, title, selected, setSelected, open, notifs }: { Icon: any; title: string; selected: string; setSelected: (title: string) => void; open: boolean; notifs?: number }) => {
...
const Logo = () => {
  return (
    <div className="grid size-10 shrink-0 place-content-center rounded-lg bg-gradient-to-br from-rose-500 to-pink-500 shadow-sm">
      <svg
        width="20"
        height="auto"
        viewBox="0 0 50 39"
