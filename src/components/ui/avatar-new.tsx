...
function AvatarNew({ className, ...props }: React.ComponentProps<typeof AvatarPrimitive.Root>) {
  return (
    <AvatarPrimitive.Root data-slot="avatar" className={cn('relative flex shrink-0 size-10', className)} {...props} />
  );
}

function AvatarImageNew({ className, ...props }: React.ComponentProps<typeof AvatarPrimitive.Image>) {
  return (
...
function AvatarFallbackNew({ className, ...props }: React.ComponentProps<typeof AvatarPrimitive.Fallback>) {
  return (
...
function AvatarIndicatorNew({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
...
export { AvatarNew, AvatarFallbackNew, AvatarImageNew, AvatarIndicatorNew, AvatarStatusNew, avatarStatusVariants };