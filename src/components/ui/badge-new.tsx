...
export interface BadgeNewProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof badgeVariants> {
  asChild?: boolean;
  dotClassName?: string;
  disabled?: boolean;
}
...
export { BadgeNew, BadgeButton, BadgeDot, badgeVariants };