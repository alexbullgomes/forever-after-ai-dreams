        ...
        <div className="p-6">
          <Card className="border-0 shadow-none">
            <CardContent className="space-y-6 p-0">
              <GoogleAuthButton googleAvailable={googleAvailable} onGoogleUnavailable={handleGoogleUnavailable} />

              <EmailAuthForm isLogin={isLogin} onToggleMode={handleToggleMode} onClose={onClose} />
            </CardContent>
          </Card>
        </div>
      </DialogContent>
