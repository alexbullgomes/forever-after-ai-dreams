    ...
    <div className="container mx-auto px-4 py-8 md:py-16 min-h-screen flex items-center justify-center">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="p-6 rounded-xl bg-white/70 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="w-16 h-16 mx-auto mb-4 p-3 rounded-full bg-rose-100">
              <Camera className="w-full h-full text-rose-500" />
            </div>
          ...
          <div className="p-6 rounded-xl bg-white/70 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="w-16 h-16 mx-auto mb-4 p-3 rounded-full bg-blue-100">
          ...
          <div className="p-6 rounded-xl bg-white/70 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="w-16 h-16 mx-auto mb-4 p-3 rounded-full bg-purple-100">
              <Sparkles className="w-full h-full text-purple-500" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Both</h3>
            <p className="text-gray-600 text-sm">
