...
export const THEME_PRESETS: Record<ThemePreset, Partial<BrandColors>> = {
  light: {
    ...
    hero_overlay_color: '0 0% 0% / 0.6',
    hero_badge_bg_color: '351 95% 71% / 0.15',
    hero_badge_icon: '351 95% 71%',
    hero_gradient_from: '222 47% 11%',
    hero_gradient_via: '280 40% 15%',
    hero_gradient_to: '351 60% 18%',
    hero_text_primary: '0 0% 100%',
    hero_text_muted: '0 0% 100% / 0.7',
    hero_trust_text: '0 0% 100% / 0.5',
    hero_glow_1_from: '351 95% 71% / 0.15',
    hero_glow_1_to: '328 86% 70% / 0.05',
    hero_glow_2_from: '271 91% 65% / 0.1',
    hero_glow_2_to: '351 95% 71% / 0.05',
    service_icon_gradient_from: '351 95% 71%',
    service_icon_gradient_to: '328 86% 70%',
    contact_bg_gradient_from: '222 47% 11%',
    contact_bg_gradient_to: '351 95% 40%',
  ...
  dark: {
    ...
    badge_bg: '350 50% 15%',
    feature_dot: '351 95% 75%',
    hero_overlay_color: '0 0% 0% / 0.7',
    hero_badge_bg_color: '351 95% 71% / 0.2',
    hero_badge_icon: '351 95% 75%',
    hero_gradient_from: '222 47% 8%',
    hero_gradient_via: '280 40% 12%',
    hero_gradient_to: '351 60% 15%',
    hero_text_primary: '0 0% 100%',
    hero_text_muted: '0 0% 100% / 0.7',
    hero_trust_text: '0 0% 100% / 0.5',
    hero_glow_1_from: '351 95% 71% / 0.12',
    hero_glow_1_to: '328 86% 70% / 0.04',
    hero_glow_2_from: '271 91% 65% / 0.08',
    hero_glow_2_to: '351 95% 71% / 0.04',
    service_icon_gradient_from: '351 95% 71%',
    service_icon_gradient_to: '328 86% 70%',
    contact_bg_gradient_from: '222 47% 8%',
    contact_bg_gradient_to: '351 95% 35%',
    cta_icon_color: '351 95% 71%',
  },
  ocean: {
    theme_preset: 'ocean',
    ...
    hero_overlay_color: '210 50% 10% / 0.6',
    hero_badge_bg_color: '199 89% 48% / 0.15',
    hero_badge_icon: '199 89% 48%',
    hero_gradient_from: '210 50% 12%',
    hero_gradient_via: '205 60% 15%',
    hero_gradient_to: '199 70% 18%',
    hero_text_primary: '0 0% 100%',
    hero_text_muted: '0 0% 100% / 0.7',
    hero_trust_text: '0 0% 100% / 0.5',
    hero_glow_1_from: '199 89% 48% / 0.15',
    hero_glow_1_to: '217 91% 60% / 0.05',
    hero_glow_2_from: '172 66% 50% / 0.1',
    hero_glow_2_to: '199 89% 48% / 0.05',
    service_icon_gradient_from: '199 89% 48%',
    service_icon_gradient_to: '217 91% 60%',
    contact_bg_gradient_from: '210 50% 12%',
    contact_bg_gradient_to: '199 89% 35%',
    cta_icon_color: '199 89% 48%',
  },
  sunset: {
    theme_preset: 'sunset',
    ...
    hero_overlay_color: '15 30% 10% / 0.6',
    hero_badge_bg_color: '25 95% 53% / 0.15',
    hero_badge_icon: '25 95% 53%',
    hero_gradient_from: '15 40% 12%',
    hero_gradient_via: '20 50% 15%',
    hero_gradient_to: '25 60% 18%',
    hero_text_primary: '0 0% 100%',
    hero_text_muted: '0 0% 100% / 0.7',
    hero_trust_text: '0 0% 100% / 0.5',
    hero_glow_1_from: '25 95% 53% / 0.15',
    hero_glow_1_to: '350 89% 60% / 0.05',
    hero_glow_2_from: '45 93% 58% / 0.1',
    hero_glow_2_to: '25 95% 53% / 0.05',
    service_icon_gradient_from: '25 95% 53%',
    service_icon_gradient_to: '350 89% 60%',
    contact_bg_gradient_from: '15 40% 12%',
    contact_bg_gradient_to: '25 95% 40%',
    cta_icon_color: '25 95% 53%',
  },
  forest: {
    theme_preset: 'forest',
    ...
    hero_overlay_color: '150 30% 8% / 0.6',
    hero_badge_bg_color: '142 76% 36% / 0.15',
    hero_badge_icon: '142 76% 36%',
    hero_gradient_from: '150 30% 10%',
    hero_gradient_via: '146 40% 13%',
    hero_gradient_to: '142 50% 16%',
    hero_text_primary: '0 0% 100%',
    hero_text_muted: '0 0% 100% / 0.7',
    hero_trust_text: '0 0% 100% / 0.5',
    hero_glow_1_from: '142 76% 36% / 0.15',
    hero_glow_1_to: '160 84% 39% / 0.05',
    hero_glow_2_from: '120 60% 45% / 0.1',
    hero_glow_2_to: '142 76% 36% / 0.05',
    service_icon_gradient_from: '142 76% 36%',
    service_icon_gradient_to: '160 84% 39%',
    contact_bg_gradient_from: '150 30% 10%',
    contact_bg_gradient_to: '142 76% 28%',
    cta_icon_color: '142 76% 36%',
  },
  monochrome: {
    theme_preset: 'monochrome',
    primary_from: '0 0% 0%',
    primary_to: '0 0% 20%',
    primary_hover_from: '0 0% 10%',
    primary_hover_to: '0 0% 30%',
    icon_bg_primary: '0 0% 0%',
    icon_bg_secondary: '0 0% 20%',
    icon_bg_accent: '0 0% 10%',
    text_accent: '0 0% 0%',
    badge_text: '0 0% 10%',
    stats_text: '0 0% 0%',
    badge_bg: '0 0% 96%',
    feature_dot: '0 0% 30%',
    hero_overlay_color: '0 0% 0% / 0.7',
    hero_badge_bg_color: '0 0% 100% / 0.1',
    hero_badge_icon: '0 0% 80%',
    hero_gradient_from: '0 0% 8%',
    hero_gradient_via: '0 0% 12%',
    hero_gradient_to: '0 0% 16%',
    hero_text_primary: '0 0% 100%',
    hero_text_muted: '0 0% 100% / 0.7',
    hero_trust_text: '0 0% 100% / 0.5',
    hero_glow_1_from: '0 0% 40% / 0.1',
    hero_glow_1_to: '0 0% 20% / 0.05',
    hero_glow_2_from: '0 0% 30% / 0.08',
    hero_glow_2_to: '0 0% 10% / 0.04',
    service_icon_gradient_from: '0 0% 0%',
    service_icon_gradient_to: '0 0% 20%',
    contact_bg_gradient_from: '0 0% 8%',
    contact_bg_gradient_to: '0 0% 25%',
    cta_icon_color: '0 0% 0%',
  },
};
